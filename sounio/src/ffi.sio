...
/// Get library version - returns version array length
/// TODO: Return raw pointer when Demetrios supports ref-to-ptr conversion
pub extern "C" fn darwin_version_len() -> usize {
    VERSION.len()
}
