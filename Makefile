...
u0-contract:
	...
	@python3 -m py_compile scripts/build_u0_work_unit_case.py scripts/plan_u0_eligible_work_shards.py scripts/execute_u0_work_shard_plan.py scripts/package_u0_work_shard_set.py
