...
readonly source_file="${U250_HOST_SOURCE:-${script_dir}/src/host.cpp}"
readonly output_file="${U250_HOST_OUTPUT:-${script_dir}/build/vector_add_host}"
...
echo "U250_HOST_BUILD_PASS ${output_file}"
