...
| Exact dinucleotide-null U250 fixture (Fase L) | BUILD/RUN PENDING | Julia-generated golden header and HLS C simulation agree on 1,024/1,024 base slots (8 cases × 8 replicates × 16 slots), tolerance 0. Real Vitis build and U250 execution must close before this row becomes PASS; no hardware claim is made from C simulation alone. |
